  ...
  return [
    {
      ...
      end: new Date(currentYear, currentMonth, 23, 10, 45),
    },
    {
      title: "English",
      allDay: false,
      start: new Date(currentYear, currentMonth, 24, 9, 0),
      end: new Date(currentYear, currentMonth, 24, 9, 45),
    },
    {
      title: "Biology",
      allDay: false,
      start: new Date(currentYear, currentMonth, 24, 10, 0),
      end: new Date(currentYear, currentMonth, 24, 10, 45),
    },
    {
      title: "Physics",
      allDay: false,
      start: new Date(currentYear, currentMonth, 25, 11, 0),
      end: new Date(currentYear, currentMonth, 25, 11, 45),
    },
    {
      title: "Chemistry",
      allDay: false,
      start: new Date(currentYear, currentMonth, 25, 13, 0),
      end: new Date(currentYear, currentMonth, 25, 13, 45),
    },
    {
      title: "History",
      allDay: false,
      start: new Date(currentYear, currentMonth, 26, 14, 0),
      end: new Date(currentYear, currentMonth, 26, 14, 45),
    },
    {
      title: "English",
      allDay: false,
      start: new Date(currentYear, currentMonth, 26, 9, 0),
      end: new Date(currentYear, currentMonth, 26, 9, 45),
    },
    {
      title: "Biology",
      allDay: false,
      start: new Date(currentYear, currentMonth, 27, 10, 0),
      end: new Date(currentYear, currentMonth, 27, 10, 45),
    },
    {
      title: "Physics",
      allDay: false,
      start: new Date(currentYear, currentMonth, 27, 11, 0),
    ...
    },
    {
      ...
      end: new Date(currentYear, currentMonth, 28, 8, 45),
    },
    {
      title: "Today's Event",
      allDay: false,
